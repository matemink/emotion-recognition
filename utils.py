...
def get_face_landmarks(image, draw=False, static_image_mode=True):
    ...
    # Process the image to detect faces and landmarks
    ...
    if results.multi_face_landmarks:
        ...
        # Draw the landmarks on the image if the draw flag is set
        if draw:
        ...
        # Extract x, y, z coordinates of each landmark and normalize them
